...
**SOC Live Response Collector v1.4.1** — один скрипт збору доказів і первинного аналізу Windows-хоста
...
> 64- і 32-біт, усі кроки OK. v1.4.1 — парсер і unit-тести; прогін на Windows попереду.
