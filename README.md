...
What a run looks like (the one-line command, host audit without IOCs; `...` — steps left out of the example for brevity). The console is in
Ukrainian, like the report.

```text
═══ SOC Live Response Collector v1.9.0 ═══
Справа: AUTO-PC17 | Хост: PC17 | Оператор: CORP\j.smith
Вікно подій: 2026-09-24 14:10:05 → 2026-09-25 14:10:05 (локальний час)
Результати: C:\SOC_Evidence\AUTO-PC17_PC17_20260925_111005Z
IOC не задано — режим аудиту хоста: усе збирається, пошук за масками/hash/IP пропущено. Для справи передайте -NamePatterns / -IocSha256 / -IocIPs / -KnownPaths.
УВАГА: результати пишуться на системний диск C: досліджуваного хоста. Для реального інциденту вкажіть -OutRoot на зовнішньому диску або мережевій папці.
[14:10:05] 0. Pre-flight: версія інструмента, час, профілі, налаштування, що впливають на докази
[14:10:06] 1.1 Швидкий знімок: netstat, TCP, процеси, UDP (без hash — щоб не втратити летючі дані)
[14:10:07] 1.2 ARP/NDP-сусіди, DNS-кеш, IP-конфігурація, маршрути
[14:10:07] 1.3 SMB: сесії, відкриті файли, шари
[14:10:08] 1.4 Процеси зі знімка: власник, батьківський процес, hash, підпис
[14:10:31] 1.5 Мережеві з'єднання TCP/UDP зі знімка (з процесом-власником)
[14:10:31] 1.6 Сесії користувачів (quser + власники explorer.exe)
[14:10:31] 2.1 Локальні облікові записи, адміністратори, політика блокування, audit policy
[14:10:32] 2.2 Служби (усі) + hash/підпис бінарників, нестандартні шляхи
[14:10:45] 2.3 Задачі планувальника: автор (з XML задачі), дії, тригери, останній/наступний запуск
   ...
[14:10:58] 2.11 Видимість за категоріями подій (auditpol + фактичні події за 24 год)
[14:11:00] 2.12 Розширена персистентність: LSA, AppInit/AppCert, Winlogon, BootExecute, Active Setup, COM, netsh, Print Monitors, SilentProcessExit, драйвери
[14:11:09] 3.1 Автентифікація: 4625 / 4624 / 4648 / 4740 / 4776, зміни облікових записів, очищення журналів
   ...
[14:11:21] 3.9 Експорт оригінальних журналів (.evtx) з hash — для переаналізу (Hayabusa, Chainsaw, EvtxECmd)
[14:11:35] 4. pfirewall.log: зведення по портах і джерелах, allow/drop, first/last, IOC IP
   ...
[14:11:38] 5.10 Сліди запуску: UserAssist, RunMRU (Win+R), ShimCache, Amcache
[14:11:40] 6.1 Brute-force: зведення 4625 (ціль, джерело, кількість, перша/остання спроба)
   ...
[14:11:41] 8. Формування HTML-звіту
[14:11:43] 9. Маніфест SHA256 усіх файлів справи
[14:11:45] 10. Архів справи

═══════════════════════════ ГОТОВО ═══════════════════════════
Звіт:        C:\SOC_Evidence\AUTO-PC17_PC17_20260925_111005Z\report.html
Папка:       C:\SOC_Evidence\AUTO-PC17_PC17_20260925_111005Z
Маніфест:    SHA256 A33B0AA012FB3C1596C04A8F4467D31CF10FE6B74DE65695C3E4ACE91E9D45AD
Архів:       C:\SOC_Evidence\AUTO-PC17_PC17_20260925_111005Z.zip
             SHA256 5E0C7A1D9B24F6E3C8A0D17B4F92E6C3A58D1B07E9F4C2A6D3B8E15F0A7C9D24
Прапорці:    Критично 0 | Високо 2 | Середньо 14 | Інфо 21
Зафіксуйте SHA256 маніфесту/архіву в тікеті — це точка контролю цілісності (chain of custody).
```

- Cyan lines `[time] N. ...` — collection steps, in NIST order (volatile data first).
- Yellow `УВАГА: ...` — warnings: no IOCs, evidence on the system drive, 32-bit PowerShell, no admin rights.
- A yellow line `    ! <error> [рядок N]` under a step means that step failed; the other steps still run. All step
  results are in `collection_steps.csv` and in the report (section "Цілісність").
- At the end: paths to the report, folder and archive, the SHA256 of the manifest and archive (record them in the
  ticket) and the flag counts.
